// Forked from Game/Board/ProceduralBoardMesh.cs for the XR edition (XR-PRD X20): a copy, never kept in sync.
...
namespace TrainSudoku.XR
{
    ...
    /// </summary>
    /// <remarks>
    /// <b>Every mesh here spans the same extents as the primitive it replaces</b>, so <c>XRBoardDisplay.ContentBounds</c>
    ...
    public static class ProceduralBoardMesh
    {
        ...
        /// It replaces the placeholder box in <c>XRBoardDisplay.BuildTunnel</c> and spans the same unit cube, so the
