...
Progress: M0 (Core rules), M1 (level editor), M2 (UI flow), M3 (3D board), M4 (piece placement with bent track meshes) and M7 (validator hookup) are done. Remaining: M8 train run, M9 JSON save, M10 level loader and levels. Assemblies:
